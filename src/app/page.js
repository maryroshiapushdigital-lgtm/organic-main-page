            ...
            <article className="oh-feat__card oh-feat__card--sandal">
              <div className="oh-feat__products">
                <div className="oh-feat__product">
                  ...
                  <span className="oh-feat__productLabel">Herbal Soap</span>
                </div>
                <div className="oh-feat__product">
                  <div className="oh-feat__productImg oh-feat__productImg--c2" />
                  <span className="oh-feat__productLabel">Natural Face Care</span>
                </div>
                <div className="oh-feat__product">
                ...
                <div className="oh-feat__product">
                  ...
                  <span className="oh-feat__productLabel">Body Care</span>
                </div>
              </div>
